                  ...
                  <form action="search.php " method="GET">  
                        ...
                        <table class="table table-striped table-bordered zero-configuration mt-40">
                            ...
                            <tbody>
                                ...
                                //  $weekend3=$setting['weekend3'];
                                //  $weekend4=$setting['weekend4'];
                                //  $weekend5=$setting['weekend5'];
                                //  $weekend6=$setting['weekend6'];
                                //  $weekend7=$setting['weekend7'];
                                //  if($weekend2 =" " && $weekend3 =" " && $weekend4 =" " && $weekend5 =" " && $weekend6 =" "){
                                //     $attendancedays= 22 ;
                                //  }
                                //  elseif($weekend3 =" " && $weekend4 =" " && $weekend5 =" " && $weekend6 = ""){
                                //    $attendancedays = 18 ;
                                //  }
                                //  else{
                                //    $attendancedays = 28;
                                ...
                                // // check_in_out
                                // $getattend = $conn -> query("SELECT * FROM attendance ")->fetch();

                                // $calcdayhour = $getattend['check_out'] - $getattend['check_in'];
                                 
                                // $dayshours = $getRecord1['Attendance days'] * $calcdayhour;
                              ...
                              <tr>
                                    ...
                                    <td><?php echo round($extratot , 2) ; ?></td>
                                    <td><?php echo round($discounttot , 2); ?></td>
                                    ...
                                    <td>
                                      <form action="invoice.php" method="GET">
                                        <input type="hidden" name="emp_id" value="<?php echo $getRecord1['emp_id']; ?>" >
