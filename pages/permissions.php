                        ...
                        <p class="card-text">DataTables has most features enabled by default, 
                            ...
                            <div class="row"><div class="col-sm-12 col-md-3"><div class="dataTables_length" id="DataTables_Table_0_length"><label>Show 
                                ...
                                <div class="col-lg-3"><button id="addRow" class="btn btn-primary mb-2"> <i class="ft-plus"></i>&nbsp;
                                   <a href="add_group.php">  Add new Group</a></button></div>
                            </div> 
       ...
       <tbody>
                <?php 
                      if(isset($_GET['search'])):
                        ...
                        $getRecord = $conn->query("SELECT gp_id , gp_name  , module_name , permission_ck 
                        FROM gpermissions WHERE gp_name LIKE '%$filtervalue%' ") -> fetchAll(PDO::FETCH_ASSOC);
                    ...
                    <?php else:?>
                        ...
                        <tr>
                         <td colspan="10"><?php echo "NO Permission Found" ?></td>
                        </tr> 
                    <?php endif; ?>                                                                                                                                                                                                                                 
                    <?php endif; ?>                                                                                                                                                                                                                           
          ...
          ?>  
                            ...
                            <tbody>
                                <tr class="user">
                                    ...
                                    <td><?php echo $rows['gp_id'];?></td>
                                    <td><?php echo $rows['gp_name'];?> </td>
                                    <td><?php echo $rows['module_name'];?> </td>
                                    <td><?php echo $rows['permission_ck'];?> </td>

                                  <form action="editpermission.php" method="GET">      
                                    <td>
                                      <input type="hidden" name="gp_id" value="<?php echo $rows['gp_id'];?>">
                                      <button class="btn btn-success mb-2"> edit </button>
                                    </td>
                                  </form>

                                  <form action="deletepermission.php" method="GET">
                                    <td>
                                    <input type="hidden" name="gp_id" value="<?php echo $rows['gp_id'];?>">
