			...
			<div class="card">
				...
				<div class="card-body">
					<div class="px-3">
						...
						<form class="form form-horizontal" action="code.php" method="POST">
							<div class="form-body">
								<h4 class="form-section">
									<i class="icon-user"></i>General information</h4>
                  <?php
                   $insertRecord=$conn->query("SELECT * FROM general_setting ") -> fetchAll(PDO::FETCH_ASSOC);
                  ?>
                            
          <div class="form-group row">
                  <input type="hidden" name="genid" value="<?php echo $insertRecord[0]['gen_id'] ; ?>">
									<label class="col-md-3 label-control" for="projectinput1">The extra: </label>
									<div class="col-md-9">
										<input type="text" id="projectinput1" class="form-control" name="extra"  value="<?php echo $insertRecord[0]['extra']; ?>">
									</div>
								</div>
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput2">
                                        Discount: </label>
									<div class="col-md-9">
										<input type="text" id="projectinput2" class="form-control" name="Discount" value="<?php echo $insertRecord[0]['discount'] ; ?>" >
									</div>
								</div>
                    ...
                    <input type="checkbox" id="vehicle1" name="day1" value="satrday" <?php if( $insertRecord[0]['weekend1'] == 'satrday'){echo "checked";} ?>  >
                    <label for="cairo">Satrday</label></br>
                    <input type="checkbox" id="vehicle2" name="day2" value="Sunday" <?php if( $insertRecord[0]['weekend2'] == 'Sunday'){echo "checked";} ?>>
                    <label for="sun"> Sunday</label><br>
                    <input type="checkbox" id="vehicle3" name="day3" value="Monday" <?php if( $insertRecord[0]['weekend3'] == 'Monday'){echo "checked";} ?>>
                    <label for="mon"> Monday</label><br>
                    <input type="checkbox" id="vehicle4" name="day4" value="Tuesday" <?php if( $insertRecord[0]['weekend4'] == 'Tuesday'){echo "checked";} ?>>
                    <label for="tue"> Tuesday</label><br>
                    <input type="checkbox" id="vehicle5" name="day5" value="Wednesday" <?php if( $insertRecord[0]['weekend5'] == 'Wednesday'){echo "checked";} ?>>
                    <label for="wed">Wednesday</label><br>
                    <input type="checkbox" id="vehicle6" name="day6" value="Turthday" <?php if( $insertRecord[0]['weekend6'] == 'Turthday'){echo "checked";} ?>>
                    <label for="tur"> Turthday</label><br> 
                    <input type="checkbox" id="vehicle7" name="day7" value="friday" <?php if( $insertRecord[0]['weekend7'] == 'friday'){echo "checked";} ?>  >
...
<!-- // Basic form layout section end -->
    ...
    <script src="../master/js/val.js"></script>
  </body>
</html>