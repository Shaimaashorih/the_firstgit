...
<head>
    ...
    <!-- <link rel="stylesheet" href="../master/boot/css/bootstrap.css">  boot -->
              ...
              <form class="form form-horizontal" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                <div class="form-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" id="projectinput1" class="form-control" name="pname">
                        </div>
                        <span id="s1"> </span>
                    </div>
                  <div class="form-group row">
            ...
            if($_SERVER['REQUEST_METHOD'] == "POST"){
               ...
               $typeid = $_POST['budget'];
                if(empty($uname) || empty($upass)){
                  ...
                  $insertRecord = $conn -> prepare("INSERT INTO users(user_username , user_password ,user_usertype)
                  VALUES(?,?,?)");
                  $insertRecord -> execute([$uname, $upass,$typeid]);
                  if($insertRecord){
