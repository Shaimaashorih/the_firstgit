      ...
      <div data-active-color="white" data-background-color="black" data-image="../app-assets/img/sidebar-bg/01.jpg" class="app-sidebar">
        <div class="sidebar-header">
          <div class="logo clearfix"><a href="index.php" class="logo-text float-left">
              <div class="logo-img"><img src="../app-assets/img/logo.png" alt=""/></div><span class="text align-middle">Hr System</span></a>
                        ...
                        <p class="card-text">DataTables has most features enabled by default, 
                            ...
                            <div class="row"><div class="col-sm-12 col-md-3"><div class="dataTables_length" id="DataTables_Table_0_length"><label>Show 
                                ...
                                <div class="col-lg-3"><button id="addRow" class="btn btn-primary mb-2"> <i class="ft-plus"></i>&nbsp;
                                   <a href="add_user.php">  Add new User</a></button></div>
                            </div> 
       ...
       <tbody>
                <?php 
                      if(isset($_GET['search'])):
                        ...
                        $getRecord = $conn->query("SELECT user_userid, user_username FROM users  WHERE user_username LIKE '%$filtervalue%' ") -> fetchAll(PDO::FETCH_ASSOC);
                    ...
                    <?php endif; ?>                                                                                                                                                                                                                           
                        ...
                        <table class="table table-striped table-bordered zero-configuration">
                            ...
                            <!-- ///////////////////////////////////////////////// -->
                                 <?php
                                  // $getrecord = $conn -> query("SELECT user_userid, user_username FROM users ");
                                  $getrecord = $conn -> query("SELECT * FROM users ");
                                ...
                                <tr class="user">
                                        ...
                                        <td>
                                            <form action="" method="GET">
                                              <input type="hidden" name="user_userid" value="<?php echo $row['user_userid']; ?>" >
                                              <button class="btn btn-gray mb-2"><?php echo ($row['user_usertype']==1)?'Active':'Inactive'; ?></button>
                                            </form>  
                                        </td>

                                        <td class="h">
                                          <form action="edituser.php" method="GET">
                                            <input type="hidden" id="run" name="user_userid" value="<?php echo $row['user_userid'];  ?>" >
