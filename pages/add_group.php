                            ...
                            <div class="row">
                                <div class="col-lg-2"></div>
                                  <div class="col-sm-12 col-md-9"><div id="DataTables_Table_0_filter"
                                    class="dataTables_filter"><label>Group Name :<input type="text" name="groupName"
                                   class="form-control form-control-sm" placeholder="" aria-controls="DataTables_Table_0" style="height: 58px;">
                                    </label>
                                  </div>
                                </div>
                            </div> 
                                      ...
                                      <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                          <select id="projectinput7" name="budget" class="form-control">
                                            ...
                                            <option value="Genral Settings">Genral Settings</option>
                                            <option value="Premissions">Premissions</option>
...
<?php
  if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $pern = implode(',' , $_POST['item']);
    $insertCK = $conn -> prepare("INSERT INTO gpermissions(gp_name ,module_name , permission_ck)
    VALUES(?,?,?) ");
    $result = $insertCK -> execute([$gpn ,$modname, $pern]);
    if($result){
