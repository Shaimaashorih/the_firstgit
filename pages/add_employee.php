...
<head>
    ...
    <!-- <link rel="stylesheet" type="text/css" href="../master/boot/css/bootstrap.css">  boot -->
  </head>
          ...
          <div class="nav-container">
             <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
                ...
                <li class="has-sub nav-item">
                   <a href="employees.php"><i class="icon-users"></i><span data-i18n="" class="menu-title"> Employees</span></a>
              ...
              <ul class="navbar-nav">
                ...
                <li class="dropdown nav-item mr-0"><a id="dropdownBasic3" href="#" data-toggle="dropdown" class="nav-link position-relative dropdown-user-link dropdown-toggle"><span class="avatar avatar-online"><img id="navbar-avatar" src="../app-assets/img/portrait/small/avatar-s-3.jpg" alt="avatar"/></span>
                  ...
                  <div aria-labelledby="dropdownBasic3" class="dropdown-menu dropdown-menu-right">
                    <div class="arrow_box_right"><a href="user-profile-page.html" class="dropdown-item py-1"><i class="ft-edit mr-2"></i><span>My Profile</span></a><a href="chat.php" class="dropdown-item py-1"><i class="ft-message-circle mr-2"></i><span>My Chat</span></a><a href="javascript:;" class="dropdown-item py-1"><i class="ft-settings mr-2"></i><span>Settings</span></a>
                      <div class="dropdown-divider"></div><a href="logout.php" class="dropdown-item"><i class="ft-power mr-2">
      ...
      <div class="main-panel">
        <div class="main-content">
          <div class="content-wrapper">
                    <!-- ----------message------------ -->
                    <?php include "../master/sections/message.php" ?>
                  <!-- --------------------------------- -->
            <div class="container-fluid">
		...
		<div class="col-md-12">
			<div class="card">
                ...
                <div class="form-group row">
									...
									<div class="col-md-9">
										<input type="text" id="projectinput10" class="form-control" name="Dateofcontract">
									</div>
                  <span id="res7"> </span>
								</div>
                <div class=" row">
...
<!-- // Basic form layout section end -->
    ...
    <!-- <script src="../master/boot/js/bootstrap.js"></script>     boot js -->
