                    ...
                    <div class="card-block card-dashboard">
                        ...
                        <div>   
                          ...
                          <div class="row"><div class="col-sm-12 col-md-3">
                            ...
                            <a href="request_attend.php"> Add attendace </a> </button>
                          </div>
       ...
       <tbody>
                <?php 
                      if(isset($_GET['search'])):
                        ...
                        $getRecord = $conn->query("SELECT  emp_name ,emp_id, attend_date, 
                                 ...
                                 <tr>
                                    ...
                                    <th>
                                      <form action="delattendance.php" method="GET">
                                        <input type="hidden" name="attend_id" value="<?php echo $row['attend_id']; ?>" >
