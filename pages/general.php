			...
			<div class="card">
				...
				<div class="card-body">
                  ...
                  <table class="table table-striped table-bordered zero-configuration">
                            ...
                            <!-- /////////////////////////////////////////////// -->
                            <?php
                                 $getRecords = $conn -> query("SELECT  gen_id ,extra , discount , weekend1      
                                 FROM general_setting") ;
                                 while ($row = $getRecords -> fetch()):
                            ?>
                            ...
                            <tbody>
                              <tr>
                                    ...
                                    <td class="h"><?php echo $row['weekend1']; ?></td>
                                    <td>
                                      <form action="editgeneral.php" method="GET">
                                        <input type="hidden" id="run" name="gen_id" value="<?php echo $row['gen_id']; ?>"  >
                                        <button class="btn btn-success mb-2" id="go" > edit </button>
                                      </form>
                                    </td>

                                    <td>
                                      <form action="delgeneral.php" method="GET" >
									...
									<div class="col-md-9">
                                         ...
                                         <!-- <form action="/action_page.php"> -->
                                          <div>
                                            ...
                                            <input type="checkbox" id="vehicle1" name="day[]" value="Satrday" >
                                            <label for="sat"> Satrday</label><br>
                                            <input type="checkbox" id="vehicle2" name="day[]" value="Sunday" >
                                            <label for="sun"> Sunday</label><br>
                                            <input type="checkbox" id="vehicle3" name="day[]" value="Monday" >
                                            <label for="mon"> Monday</label><br>
                                            <input type="checkbox" id="vehicle4" name="day[]" value="Tuesday" >
                                            <label for="sun"> Tuesday</label><br>
                                            <input type="checkbox" id="vehicle5" name="day[]" value="Wednesday" >
                                            <label for="Fri">Wednesday</label><br>
                                            <input type="checkbox" id="vehicle6" name="day[]" value="Turthday" >
                                            <label for="sun"> Turthday</label><br>
                                            <input type="checkbox" id="vehicle7" name="day[]" value="Friday" >
        ...
        <!-- ---------------------------- -->
         <?php 
          if($_SERVER['REQUEST_METHOD'] == 'POST'){
            ...
            $day1 = implode( ',' ,$_POST['day']);
            $insertRecord = $conn -> prepare("INSERT INTO general_setting ( extra , discount, weekend1   )
             VALUES (? , ? ,? )");
            $result =$insertRecord -> execute([$extra , $discount , $day1  ]);
            if($result){
